...
class EEGNet(nn.Module):
    def __init__(self,
                 chunk_size: int = 2500,
                 num_electrodes: int = 65,
                 F1: int = 8,
                 F2: int = 16,
                 D: int = 2,
                 num_classes: int = 2,
                 kernel_1: int = 250, # half of sampling rate
                 kernel_2: int = 64,
                 dropout: float = 0.25):
...
class EEGNet_BNN(nn.Module):
    def __init__(self,
                 ...
                 num_classes: int = 2,
                 kernel_1: int = 250, # half of sampling rate
                 kernel_2: int = 64, #  sampling rate / 8
                 dropout: float = 0.25):
        ...
        self.lin_mu = nn.Linear(self.feature_dim(), num_classes, bias=False)
        self.lin_sigma = nn.Linear(self.feature_dim(), num_classes, bias=False)
